...
```{}
1.
In the boxplot, the x axis is different SNP alleles (0, 1, 2) in Belgian Shepherds, German Shepherds, and Labrador Retrievers and the y axis is the fructosamine concentration for each of the SNP alleles by breed.
Results by allels:
...
2.
The most significant SNP is BICF2S2344808, located in chromosome 3, postion 65209415.
